                ...
                <div className="site-header-inside">
                  <div className="site-branding">
                    ...
                    <p className="site-logo">
                      <Link to={withPrefix('/')}>
                        <img src={withPrefix(_.get(this.props, 'pageContext.site.siteMetadata.header.logo_img', null))} alt={_.get(this.props, 'pageContext.site.siteMetadata.header.image_alt', null)} />
                      </Link>
                    </p>
                    )}
