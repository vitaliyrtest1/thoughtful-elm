                  ...
                  <div className="footer-widgets">
                    <div className="widget footer-branding">
                      ...
                      <p className="site-logo">
                        <Link to={withPrefix('/')}><img src={withPrefix(_.get(this.props, 'pageContext.site.siteMetadata.footer.logo_img', null))} alt={_.get(this.props, 'pageContext.site.siteMetadata.footer.image_alt', null)} /></Link>
                      </p>
                      ) : 
